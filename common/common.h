...
struct common_params {
    ...
    bool lora_init_without_apply = false; // only load lora to memory, but do not apply it to ctx (user can manually apply lora later using monowire_adapter_lora_apply)
...
bool common_prompt_batch_decode(
    ...
    const std::vector<monowire_token> & embd,
                               int & n_past,
                               int   n_batch,
