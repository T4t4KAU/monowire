...
int main(int argc, char ** argv) {
    ...
    //GGML_ASSERT(monowire_vocab_type(model) == MONOWIRE_VOCAB_TYPE_SPM);
    if (monowire_vocab_type(vocab) != MONOWIRE_VOCAB_TYPE_SPM) {
        return 99;
    }
    ...
    for (int i = 0; i < n_vocab; ++i) {
        ...
        std::vector<monowire_token> tokens = common_tokenize(ctx, str, false, true);
