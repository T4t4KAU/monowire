...
void string_to_spv_func(std::string name, std::string in_path, std::string out_path, std::map<std::string, std::string> defines, bool coopmat, bool dep_file, compile_count_guard slot) {
    ...
    // disable spirv-opt for coopmat shaders for upstream-reference
    // disable spirv-opt for bf16 shaders for upstream-reference
    // disable spirv-opt for rope shaders for upstream-reference
