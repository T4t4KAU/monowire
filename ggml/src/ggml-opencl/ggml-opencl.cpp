...
#pragma message("TODO: implement BF16, Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, IQ4_NL support (upstream-reference)")
        ...
        case GGML_OP_PAD:
            // TODO: add circular padding support for opencl, see upstream-reference
...
static enum ggml_status ggml_backend_opencl_buffer_init_tensor(ggml_backend_buffer_t buffer, ggml_tensor * tensor) {
    ...
    if (tensor->view_src != nullptr) {
        ...
        // ggml_alloc.c in upstream-reference
...
static void ggml_cl_soft_max(ggml_backend_t backend, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    // ops before softmax. It now also fuses alibi if `max_bias > 0`. For decoder models,
