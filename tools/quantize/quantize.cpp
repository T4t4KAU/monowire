...
// changes to this struct must also be reflected in src/monowire-quant.cpp
...
struct quant_option {
    std::string name;
    monowire_ftype ftype;
    std::string desc;
};

static const std::vector<quant_option> QUANT_OPTIONS = {
    { "Q1_0",     MONOWIRE_FTYPE_MOSTLY_Q1_0,     " 1.125 bpw quantization",           },
    { "Q4_0",     MONOWIRE_FTYPE_MOSTLY_Q4_0,     " 4.34G, +0.4685 ppl @ reference-8B",  },
    { "Q4_1",     MONOWIRE_FTYPE_MOSTLY_Q4_1,     " 4.78G, +0.4511 ppl @ reference-8B",  },
    { "MXFP4_MOE",MONOWIRE_FTYPE_MOSTLY_MXFP4_MOE," MXFP4 MoE",  },
    { "Q5_0",     MONOWIRE_FTYPE_MOSTLY_Q5_0,     " 5.21G, +0.1316 ppl @ reference-8B",  },
    { "Q5_1",     MONOWIRE_FTYPE_MOSTLY_Q5_1,     " 5.65G, +0.1062 ppl @ reference-8B",  },
    { "IQ2_XXS",  MONOWIRE_FTYPE_MOSTLY_IQ2_XXS,  " 2.06 bpw quantization",            },
    { "IQ2_XS",   MONOWIRE_FTYPE_MOSTLY_IQ2_XS,   " 2.31 bpw quantization",            },
    { "IQ2_S",    MONOWIRE_FTYPE_MOSTLY_IQ2_S,    " 2.5  bpw quantization",            },
    { "IQ2_M",    MONOWIRE_FTYPE_MOSTLY_IQ2_M,    " 2.7  bpw quantization",            },
    { "IQ1_S",    MONOWIRE_FTYPE_MOSTLY_IQ1_S,    " 1.56 bpw quantization",            },
    { "IQ1_M",    MONOWIRE_FTYPE_MOSTLY_IQ1_M,    " 1.75 bpw quantization",            },
    { "TQ1_0",    MONOWIRE_FTYPE_MOSTLY_TQ1_0,    " 1.69 bpw ternarization",           },
    { "TQ2_0",    MONOWIRE_FTYPE_MOSTLY_TQ2_0,    " 2.06 bpw ternarization",           },
    { "Q2_K",     MONOWIRE_FTYPE_MOSTLY_Q2_K,     " 2.96G, +3.5199 ppl @ reference-8B",  },
    { "Q2_K_S",   MONOWIRE_FTYPE_MOSTLY_Q2_K_S,   " 2.96G, +3.1836 ppl @ reference-8B",  },
    { "IQ3_XXS",  MONOWIRE_FTYPE_MOSTLY_IQ3_XXS,  " 3.06 bpw quantization",            },
    { "IQ3_S",    MONOWIRE_FTYPE_MOSTLY_IQ3_S,    " 3.44 bpw quantization",            },
    { "IQ3_M",    MONOWIRE_FTYPE_MOSTLY_IQ3_M,    " 3.66 bpw quantization mix",        },
    { "Q3_K",     MONOWIRE_FTYPE_MOSTLY_Q3_K_M,   "alias for Q3_K_M"                   },
    { "IQ3_XS",   MONOWIRE_FTYPE_MOSTLY_IQ3_XS,   " 3.3 bpw quantization",             },
    { "Q3_K_S",   MONOWIRE_FTYPE_MOSTLY_Q3_K_S,   " 3.41G, +1.6321 ppl @ reference-8B",  },
    { "Q3_K_M",   MONOWIRE_FTYPE_MOSTLY_Q3_K_M,   " 3.74G, +0.6569 ppl @ reference-8B",  },
    { "Q3_K_L",   MONOWIRE_FTYPE_MOSTLY_Q3_K_L,   " 4.03G, +0.5562 ppl @ reference-8B",  },
    { "IQ4_NL",   MONOWIRE_FTYPE_MOSTLY_IQ4_NL,   " 4.50 bpw non-linear quantization", },
    { "IQ4_XS",   MONOWIRE_FTYPE_MOSTLY_IQ4_XS,   " 4.25 bpw non-linear quantization", },
    { "Q4_K",     MONOWIRE_FTYPE_MOSTLY_Q4_K_M,   "alias for Q4_K_M",                  },
    { "Q4_K_S",   MONOWIRE_FTYPE_MOSTLY_Q4_K_S,   " 4.37G, +0.2689 ppl @ reference-8B",  },
    { "Q4_K_M",   MONOWIRE_FTYPE_MOSTLY_Q4_K_M,   " 4.58G, +0.1754 ppl @ reference-8B",  },
    { "Q5_K",     MONOWIRE_FTYPE_MOSTLY_Q5_K_M,   "alias for Q5_K_M",                  },
    { "Q5_K_S",   MONOWIRE_FTYPE_MOSTLY_Q5_K_S,   " 5.21G, +0.1049 ppl @ reference-8B",  },
    { "Q5_K_M",   MONOWIRE_FTYPE_MOSTLY_Q5_K_M,   " 5.33G, +0.0569 ppl @ reference-8B",  },
    { "Q6_K",     MONOWIRE_FTYPE_MOSTLY_Q6_K,     " 6.14G, +0.0217 ppl @ reference-8B",  },
    { "Q8_0",     MONOWIRE_FTYPE_MOSTLY_Q8_0,     " 7.96G, +0.0026 ppl @ reference-8B",  },
    { "F16",      MONOWIRE_FTYPE_MOSTLY_F16,      "14.00G, +0.0020 ppl @ Mistral-7B",  },
    { "BF16",     MONOWIRE_FTYPE_MOSTLY_BF16,     "14.00G, -0.0050 ppl @ Mistral-7B",  },
    { "F32",      MONOWIRE_FTYPE_ALL_F32,         "26.00G              @ 7B",          },
    // Note: Ensure COPY comes after F32 to avoid ftype 0 from matching.
    { "COPY",     MONOWIRE_FTYPE_ALL_F32,         "only copy tensors, no quantizing",  },
};
...
static bool try_parse_ftype(const std::string & ftype_str_in, monowire_ftype & ftype, std::string & ftype_str_out) {
...
static void usage(const char * executable) {
    ...
    printf("                                      example: monowire-quantize --dry-run model-f32.gguf Q4_K\n\n");
...
int main(int argc, char ** argv) {
    ...
    monowire_model_quantize_params params = monowire_model_quantize_default_params();
    ...
    std::vector<monowire_model_imatrix_data> i_data;
    std::vector<monowire_model_tensor_override> t_override;
    if (!imatrix_data.empty()) {
        ...
        {
            monowire_model_kv_override kvo;
            std::strcpy(kvo.key, LLM_KV_QUANTIZE_IMATRIX_FILE);
            kvo.tag = MONOWIRE_KV_OVERRIDE_TYPE_STR;
        ...
        }
        {
            ...
            kvo.tag = MONOWIRE_KV_OVERRIDE_TYPE_INT;
    ...
    const int64_t t_main_start_us = monowire_time_us();

    int64_t t_quantize_us = 0;

    // load the model
    {
        const int64_t t_start_us = monowire_time_us();

        if (monowire_model_quantize(fname_inp.c_str(), fname_out.c_str(), &params)) {
            fprintf(stderr, "%s: failed to quantize model from '%s'\n", __func__, fname_inp.c_str());
            return 1;
        }

        t_quantize_us = monowire_time_us() - t_start_us;
    }

    // report timing
    {
        const int64_t t_main_end_us = monowire_time_us();
