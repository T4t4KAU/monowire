...
// Uses: LayerNorm (not RMSNorm), relu2 activation, separate Q/K/V, RoPE
// embeddings
llm_build_jais2::llm_build_jais2(const monowire_model &model, const llm_graph_params &params)
