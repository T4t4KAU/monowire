...
template <bool iswa>
llm_build_phi3<iswa>::llm_build_phi3(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            auto [Qcur, Kcur, Vcur] = build_qkv(model.layers[il], attn_norm_output, n_embd_head, n_head, n_head_kv, il);
            ...
            cur = build_attn(inp_attn, model.layers[il].wo, model.layers[il].wo_b, model.layers[il].wo_s, Qcur, Kcur,
                             Vcur, nullptr, nullptr, nullptr, 1.0f, il);
        }
