...
llm_build_granite::llm_build_granite(const monowire_model &model, const llm_graph_params &params)
...
ggml_tensor *llm_build_granite::build_attention_layer(ggml_tensor *cur, ggml_tensor *inp_pos,
                                                      llm_graph_input_attn_kv *inp_attn, const monowire_model &model,
...
ggml_tensor *llm_build_granite::build_layer_ffn(ggml_tensor *cur, ggml_tensor *inpSA, const monowire_model &model,
                                                const int il) {
