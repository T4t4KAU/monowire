...
template <bool iswa>
llm_build_plamo3<iswa>::llm_build_plamo3(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        cur = build_attn(inp_attn, model.layers[il].wo, NULL, model.layers[il].wo_s, Qcur, Kcur, Vcur, nullptr, nullptr,
                         nullptr, attn_scale, il);
        cb(cur, "attn_out", il);
