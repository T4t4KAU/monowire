...
llm_build_afmoe::llm_build_afmoe(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            cur = build_attn(inp_attn, NULL, NULL, NULL, // wo will be applied after gating
