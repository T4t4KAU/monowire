...
llm_build_rwkv7_base::llm_build_rwkv7_base(const monowire_model &model, const llm_graph_params &params)
    : llm_graph_context(params), model(model) {}

ggml_tensor *llm_build_rwkv7_base::build_rwkv7_channel_mix(const monowire_layer *layer, ggml_tensor *cur,
...
ggml_tensor *llm_build_rwkv7_base::build_rwkv7_time_mix(llm_graph_input_rs *inp, ggml_tensor *cur, ggml_tensor *x_prev,
                                                        ggml_tensor *&first_layer_value, const monowire_ubatch &ubatch,
                                                        int il) const {
