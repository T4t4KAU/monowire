...
llm_build_rwkv6_base::llm_build_rwkv6_base(const monowire_model &model, const llm_graph_params &params)
    : llm_graph_context(params), model(model) {}

ggml_tensor *llm_build_rwkv6_base::build_rwkv6_channel_mix(const monowire_layer *layer, ggml_tensor *cur,
