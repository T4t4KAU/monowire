...
llm_build_ernie4_5_moe::llm_build_ernie4_5_moe(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        if (!is_moe_layer) {
            ...
            ggml_tensor *moe_out = build_moe_ffn(
                ...
                true, hparams.expert_weights_scale, MONOWIRE_EXPERT_GATING_FUNC_TYPE_SOFTMAX, il);
