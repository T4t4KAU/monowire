...
llm_build_exaone_moe::llm_build_exaone_moe(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_transformer_layers; ++il) {
        ...
        // self-attention
        {
            ...
            cur = build_attn(inp_attn_iswa, model.layers[il].wo, NULL, model.layers[il].wo_s, Qcur, Kcur, Vcur, nullptr,
