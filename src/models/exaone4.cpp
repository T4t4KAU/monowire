...
template <bool iswa>
llm_build_exaone4<iswa>::llm_build_exaone4(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        const bool use_rope = hparams.is_swa(il) || hparams.swa_type == MONOWIRE_SWA_TYPE_NONE;
