...
llm_build_grovemoe::llm_build_grovemoe(const monowire_model &model, const llm_graph_params &params)
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        ggml_tensor *moe_out
            = build_moe_ffn(cur, nullptr, model.layers[il].ffn_up_exps, model.layers[il].ffn_gate_exps,
                            ...
                            hparams.expert_weights_scale, MONOWIRE_EXPERT_GATING_FUNC_TYPE_SOFTMAX, il, probs);
