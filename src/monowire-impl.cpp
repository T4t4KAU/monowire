...
struct monowire_logger_state {
    ggml_log_callback log_callback = monowire_log_callback_default;
    void *log_callback_user_data = nullptr;
};

static monowire_logger_state g_logger_state;
...
void monowire_log_get(ggml_log_callback *log_callback, void **user_data) { ggml_log_get(log_callback, user_data); }

void monowire_log_set(ggml_log_callback log_callback, void *user_data) {
    ggml_log_set(log_callback, user_data);
    g_logger_state.log_callback = log_callback ? log_callback : monowire_log_callback_default;
    g_logger_state.log_callback_user_data = user_data;
}

static void monowire_log_internal_v(ggml_log_level level, const char *format, va_list args) {
    va_list args_copy;
...
void monowire_log_internal(ggml_log_level level, const char *format, ...) {
    ...
    monowire_log_internal_v(level, format, args);
    va_end(args);
}
